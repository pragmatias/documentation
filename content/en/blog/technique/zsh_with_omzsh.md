...
4. Installation of [iTerm2](https://iterm2.com/) , [ZSH](https://www.zsh.org/), [FZF](https://github.com/junegunn/fzf), [FD](https://github.com/sharkdp/fd), [Tree](https://www.computerhope.com/unix/tree.htm)
...
2. Open the Windows Terminal and navigate to `Windows Terminal > Settings`
    ...
    2. Go to `Open your settings.json file`
        1. Paste the color scheme in the `schemes` tag
```json
"schemes": 
[
    {...},
...
1. Execute the command `p10k configuration` in the `iterm2` terminal with `zsh` shell
    1. Prompt Style : `Lean`
